import { T as TraceType, L as LaminarSpanContext, a as TracingLevel, I as InitializeOptions } from './evaluations-Bu7nHmvf.mjs';
export { C as ChatMessage, D as Datapoint, c as Dataset, f as Event, H as HumanEvaluator, b as LaminarClient, d as LaminarDataset, N as NodeInput, P as PipelineRunRequest, g as PipelineRunResponse, e as evaluate } from './evaluations-Bu7nHmvf.mjs';
import { AttributeValue, TimeInput, Context, Span } from '@opentelemetry/api';
 ...
 * });
 */
declare function observe<A extends unknown[], F extends (...args: A) => ReturnType<F>>({ name, sessionId, traceType, spanType, input, ignoreInput, ignoreOutput, parentSpanContext, }: ObserveOptions, fn: F, ...args: A): Promise<ReturnType<F>>;
/**
 ...
 * ```
 */
declare function withLabels<A extends unknown[], F extends (...args: A) => ReturnType<F>>(labels: string[], fn: F, ...args: A): ReturnType<F>;
/**
...
declare class Laminar {
     ...
     */
    static setProjectApiKey(projectApiKey?: string): void;
    /**
     ...
     * // |  |  | openai.chat
     */
    static startSpan({ name, input, spanType, context, parentSpanContext, labels, }: {
        name: string;
        input?: any;
    ...
    static serializeLaminarSpanContext(span?: Span): string | null;
    static getLaminarSpanContext(span?: Span): LaminarSpanContext | null;
    static shutdown(): Promise<void>;
    static getHttpUrl(): string;
    static getProjectApiKey(): string;
}

export { Laminar, LaminarAttributes, LaminarSpanContext, TracingLevel, observe, withLabels, withTracingLevel };
